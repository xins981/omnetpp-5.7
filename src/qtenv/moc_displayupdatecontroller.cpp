...
void omnetpp::qtenv::DisplayUpdateController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DisplayUpdateController::playbackSpeedChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DisplayUpdateController::runModeChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::DisplayUpdateController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__DisplayUpdateController.data,
