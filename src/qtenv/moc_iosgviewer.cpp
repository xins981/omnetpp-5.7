...
void omnetpp::qtenv::IOsgViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (IOsgViewer::*)(const std::vector<cObject*> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IOsgViewer::objectsPicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::IOsgViewer::staticMetaObject = { {
    &QOpenGLWidget::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__IOsgViewer.data,
    qt_meta_data_omnetpp__qtenv__IOsgViewer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void omnetpp::qtenv::DummyOsgViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DummyOsgViewer::*)(const std::vector<cObject*> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DummyOsgViewer::objectsPicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::DummyOsgViewer::staticMetaObject = { {
    &IOsgViewer::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__DummyOsgViewer.data,
    qt_meta_data_omnetpp__qtenv__DummyOsgViewer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
