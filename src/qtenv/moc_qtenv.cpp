...
void omnetpp::qtenv::Qtenv::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Qtenv::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qtenv::fontChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Qtenv::*)(cObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qtenv::objectDeletedSignal)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::Qtenv::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__Qtenv.data,
    qt_meta_data_omnetpp__qtenv__Qtenv,
    qt_static_metacall,
    nullptr,
    nullptr
} };
