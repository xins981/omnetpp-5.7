...
void omnetpp::qtenv::HistogramView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (HistogramView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistogramView::showCellInfo)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::HistogramView::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__HistogramView.data,
    qt_meta_data_omnetpp__qtenv__HistogramView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
