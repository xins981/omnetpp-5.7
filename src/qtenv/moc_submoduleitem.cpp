...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_omnetpp__qtenv__SubmoduleItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_omnetpp__qtenv__SubmoduleItem_t qt_meta_stringdata_omnetpp__qtenv__SubmoduleItem = {
    {
QT_MOC_LITERAL(0, 0, 29), // "omnetpp::qtenv::SubmoduleItem"
QT_MOC_LITERAL(1, 30, 17), // "onPositionChanged"
QT_MOC_LITERAL(2, 48, 0) // ""

    },
    "omnetpp::qtenv::SubmoduleItem\0"
    "onPositionChanged\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_omnetpp__qtenv__SubmoduleItem[] = {
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::SubmoduleItem::staticMetaObject = { {
    &QGraphicsObject::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__SubmoduleItem.data,
