...
public:
    ...
    {
        AreaSelectorDialog->setWindowTitle(QApplication::translate("AreaSelectorDialog", "Select Area", nullptr));
        areaGroup->setTitle(QApplication::translate("AreaSelectorDialog", "Area:", nullptr));
        boundingBox->setText(QApplication::translate("AreaSelectorDialog", "All graphical elements", nullptr));
        moduleRectangle->setText(QApplication::translate("AreaSelectorDialog", "Module rectangle", nullptr));
        viewport->setText(QApplication::translate("AreaSelectorDialog", "Viewport", nullptr));
        marginLabel->setText(QApplication::translate("AreaSelectorDialog", "Margin (px):", nullptr));
    } // retranslateUi
