...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::ComboSelectionDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__ComboSelectionDialog.data,
    qt_meta_data_omnetpp__qtenv__ComboSelectionDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
