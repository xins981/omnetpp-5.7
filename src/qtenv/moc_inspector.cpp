...
void omnetpp::qtenv::Inspector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Inspector::selectionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Inspector::*)(cObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Inspector::objectDoubleClicked)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Inspector::inspectedObjectChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::Inspector::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__Inspector.data,
