...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::OutputVectorInspector::staticMetaObject = { {
    &Inspector::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__OutputVectorInspector.data,
    qt_meta_data_omnetpp__qtenv__OutputVectorInspector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
