...
void omnetpp::qtenv::TextViewerContentProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextViewerContentProvider::textChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextViewerContentProvider::linesDiscarded)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::TextViewerContentProvider::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__TextViewerContentProvider.data,
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::StringTextViewerContentProvider::staticMetaObject = { {
    &TextViewerContentProvider::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__StringTextViewerContentProvider.data,
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::ModuleOutputContentProvider::staticMetaObject = { {
    &TextViewerContentProvider::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__ModuleOutputContentProvider.data,
