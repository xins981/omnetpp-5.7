...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_omnetpp__qtenv__FileEditor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_omnetpp__qtenv__FileEditor_t qt_meta_stringdata_omnetpp__qtenv__FileEditor = {
    {
QT_MOC_LITERAL(0, 0, 26), // "omnetpp::qtenv::FileEditor"
QT_MOC_LITERAL(1, 27, 4), // "save"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 4), // "find"
QT_MOC_LITERAL(4, 38, 28), // "onCustomContextMenuRequested"
QT_MOC_LITERAL(5, 67, 3), // "pos"
QT_MOC_LITERAL(6, 71, 9), // "wrapLines"
QT_MOC_LITERAL(7, 81, 8) // "findNext"

    },
    "omnetpp::qtenv::FileEditor\0save\0\0find\0"
    "onCustomContextMenuRequested\0pos\0"
    "wrapLines\0findNext"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_omnetpp__qtenv__FileEditor[] = {
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::FileEditor::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__FileEditor.data,
