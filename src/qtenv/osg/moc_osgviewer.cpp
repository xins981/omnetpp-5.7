...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::HeartBeat::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__HeartBeat.data,
...
void omnetpp::qtenv::OsgViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OsgViewer::objectsPicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::OsgViewer::staticMetaObject = { {
    &IOsgViewer::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__OsgViewer.data,
