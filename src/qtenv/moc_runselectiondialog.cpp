...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_omnetpp__qtenv__RunSelectionDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_omnetpp__qtenv__RunSelectionDialog_t qt_meta_stringdata_omnetpp__qtenv__RunSelectionDialog = {
    {
QT_MOC_LITERAL(0, 0, 34), // "omnetpp::qtenv::RunSelectionD..."
QT_MOC_LITERAL(1, 35, 22), // "configSelectionChanged"
QT_MOC_LITERAL(2, 58, 0), // ""
QT_MOC_LITERAL(3, 59, 5) // "index"

    },
    "omnetpp::qtenv::RunSelectionDialog\0"
    "configSelectionChanged\0\0index"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_omnetpp__qtenv__RunSelectionDialog[] = {
...
void omnetpp::qtenv::RunSelectionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->configSelectionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::RunSelectionDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__RunSelectionDialog.data,
