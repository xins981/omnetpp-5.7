...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::RunUntilDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__RunUntilDialog.data,
    qt_meta_data_omnetpp__qtenv__RunUntilDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
