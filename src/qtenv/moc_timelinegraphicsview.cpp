...
void omnetpp::qtenv::TimeLineGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeLineGraphicsView::contextMenuRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeLineGraphicsView::click)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TimeLineGraphicsView::*)(cObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeLineGraphicsView::doubleClick)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject omnetpp::qtenv::TimeLineGraphicsView::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_omnetpp__qtenv__TimeLineGraphicsView.data,
